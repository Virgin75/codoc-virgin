"""
Django settings for betterlife project.
...
SECRET_KEY = 'django-insecure-rrpu%(7=fbohe=juh3)-cay-$f=h^9(0)^afkb6qi=qc7uz@wp'
...
WSGI_APPLICATION = 'betterlife.wsgi.application'
